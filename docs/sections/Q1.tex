...
Test performance is summarized by the results shown in Figs.~\ref{fig:q1-f1}--\ref{fig:q1-f3}, which report Macro-F1, Macro-Recall, and Accuracy, respectively. These plots show, for each classifier, the performance obtained under each vectorization method, allowing robust trends to be identified immediately.
